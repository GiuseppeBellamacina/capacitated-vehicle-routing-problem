...
L'HGA adotta un'\textbf{educazione a due livelli}: il 2-opt (JIT-compilato con
Numba) \`e applicato al 100\% dei figli (\textit{light}), mentre la ricerca
locale completa (2-opt + Or-opt + Relocate + Exchange) \`e riservata a una
frazione $p_{ls}$ dei figli (\textit{full}), ottimizzando il rapporto
qualit\`a/tempo CPU.
\begin{itemize}[nosep]
