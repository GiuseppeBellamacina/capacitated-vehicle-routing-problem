...
\usepackage[a4paper, top=1.8cm, bottom=1.8cm, left=1.8cm, right=1.8cm, headheight=12pt]{geometry}
...
\SetKwFor{ForEach}{per ogni}{fai}{fine per ogni}
...
\title{\vspace{-2cm}\Large\textbf{Capacitated Vehicle Routing Problem}\\\large Soluzione tramite Algoritmo Genetico Ibrido (HGA)}
\author{\textbf{Giuseppe Bellamacina} -- Matricola 1000030349\\[0.2cm]Corso di Artificial and Swarm Intelligence\\Prof. Mario Francesco Pavone\\Universit\`a degli Studi di Catania\\Dipartimento di Matematica e Informatica\\Anno Accademico 2025/2026}
\date{}
...
\input{parts/algoritmo}
\input{parts/protocollo}
